    ...
    <div className="bg-card rounded-xl shadow-soft-md border border-subtle p-6">
      ...
      <div className="space-y-4">
        {safeCourses.map((course) => (
          <div key={course?.id || Math.random()} className="bg-surface rounded-lg p-4 hover:shadow-soft-sm transition-all duration-200">
                ...
                <div className="flex items-start justify-between mb-2">
                  ...
                  <div className="text-right ml-4">
                    ...
                    <p className="text-xs font-caption text-text-muted">
                      {formatDuration(course?.timeRemaining || 0)} left
                    </p>
                  </div>
                </div>
